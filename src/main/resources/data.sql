...
INSERT INTO `accounts` (`id`, `password`, `rol`, `username`, `id_country_house_fk`, `admin`) VALUES ('1', 'contra123', '1', 'user_one', '1', true);
INSERT INTO `accounts` (`id`, `password`, `rol`, `username`, `id_country_house_fk`, `admin`) VALUES ('2', 'contra123', '1', 'user_two', '2', true);
INSERT INTO `accounts` (`id`, `password`, `rol`, `username`, `id_country_house_fk`, `admin`) VALUES ('3', 'contra123', '1', 'user_three', '3', true);
INSERT INTO `accounts` (`id`, `password`, `rol`, `username`, `id_country_house_fk`, `admin`) VALUES ('4', 'contra123', '1', 'user_four', '4', true);
